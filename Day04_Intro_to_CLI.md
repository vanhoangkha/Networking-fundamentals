...
## 04.1 CLI là gì?
**CLI** (Command-Line Interface) là **giao diện dòng lệnh** được sử dụng để cấu hình và quản lý các thiết bị Cisco.
...
**Cổng Console** là phương pháp kết nối **bắt buộc** khi lần đầu cấu hình thiết bị.

**Loại cáp sử dụng:**
- **Cáp Rollover**: Kết nối từ cổng console thiết bị đến máy tính
- **Đầu nối**: DB9 Serial sang RJ45 HOẶC DB9 Serial sang USB
...
## 04.7 Ví dụ thực tế về mã hóa mật khẩu
...
## 04.9 Các hình ảnh minh họa bổ sung
