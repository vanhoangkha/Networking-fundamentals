...
## 22.25 CẤU HÌNH STP
## 22.26 Lệnh cấu hình Spanning-Tree mode trên Switch:
...
## 22.28 Lệnh cấu hình Spanning-Tree PRIMARY Root Bridge trên Switch:
...
## 22.31 Lệnh cấu hình Spanning-Tree SECONDARY Root Bridge trên Switch:
...
## 22.33 VLAN 1 Topology chạy PVST+:
...
## 22.35 CẤU HÌNH STP PORT SETTINGS
