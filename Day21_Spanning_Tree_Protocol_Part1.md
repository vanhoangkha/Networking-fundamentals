...
## 21.2 Tầm quan trọng của Redundancy:
...
## 21.3 VÍ DỤ VỀ MẠNG THIẾT KẾ KÉM
...
## 21.6 TẠI SAO DƯ THỪA CÓ THỂ LÀ ĐIỀU XẤU?
## 21.7 BROADCAST STORM
...
## 21.8 VẤN ĐỀ MAC ADDRESS FLAPPING
...
## 21.9 GIẢI PHÁP: SPANNING TREE PROTOCOL
...
## 21.10 STP (SPANNING TREE PROTOCOL): 802.1D
## 21.11 Đặc điểm cơ bản:
...
## 21.12 CÁCH HOẠT ĐỘNG CỦA STP
## 21.13 Nguyên tắc cơ bản:
...
## 21.15 BPDU ĐƯỢC SỬ DỤNG ĐỂ LÀM GÌ?
## 21.16 Bầu chọn Root Bridge:
...
## 21.19 CÁC BƯỚC CỦA SPANNING TREE PROTOCOL
## 21.20 Bước 1: Bầu chọn Root Bridge
...
## 21.22 Bước 3: Chọn Designated Port
...
## 21.25 XÁC ĐỊNH PORT NÀO SẼ BỊ CHẶN
![image](https://github.com/psaumur/CCNA/assets/106411237/1b69a092-4150-44c3-b605-5916fdea91d6)

- --

## 21.26 BÀI TẬP THỰC HÀNH
## 21.27 Xác định Root Bridge và VAI TRÒ của MỖI Interface trên Mạng (ROOT / DESIGNATED / NON-DESIGNATED)
## 21.28 Bài tập #1:
