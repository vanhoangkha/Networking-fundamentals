...
## 20.34 VTP DOMAIN
## 20.35 Quy tắc tự động tham gia:
...
## 20.36 REVISION NUMBER
## 20.37 Hai cách RESET Revision Number về 0:
1. **Thay đổi VTP Domain** thành Domain chưa sử dụng
2. **Thay đổi VTP mode** thành TRANSPARENT

- --

## 20.38 VTP VERSION NUMBER
## 20.39 Cấu hình:
```
...
## 20.40 TÓM TẮT VÀ KHUYẾN NGHỊ
## 20.41 Khuyến nghị bảo mật:
